...
! function (t) {
        ...
        var f = function (t, e, n) {
                ...
                return function o(u, s) {
                    ...
                    return d.constructor = c, c.mixin = function (e) {
                        ...
                        if (l = {}, r(t) ? l = t.call(c, d, h, c, u) : i(t) && (l = t), i(l))
        ...
        var F = e.frame = function () {
            ...
            N = f(function (e) {
                ...
                e.init = function (e) {
                    ...
                    A.backface && B.hideBackface && W(this.el, A.backface.css, "hidden")
                ...
                }), w("next", a), w("stop", u), w("set", function (t) {
                    u.call(this, t), d.call(this, t, m, y)
                }), w("show", function (t) {
            ...
            R = f(q, function (t, e) {
                ...
                t.init = function () {
                    e.init.apply(this, arguments), this.current || (this.current = {}, J.perspective && B.perspective && (this.current.perspective = B.perspective, W(this.el, this.name, this.style(this.current)), this.redraw()))
                }, t.set = function (t) {
    ...
    t.exports = function (t, e, n, p, v, m, g) {
        ...
        if (M && (b = f(M.call(new t))) !== Object.prototype && b.next && (c(b, _, !0), i || "function" == typeof b[l] || a(b, l, d)), O && E && "values" !== E.name && (k = !0, j = function () {
                return E.call(this)
            }), i && !g || !h && !k && S[l] || a(S, l, j), u[e] = j, u[_] = d, v)
            if (y = {
                    values: O ? j : x("values"),
                    keys: m ? j : x("keys"),
                    entries: T
    ...
    var i = n(0),
        ...
        s = function (t, e, n) {
            ...
            for (c in d && (n = e), n)(f = !h && b && void 0 !== b[c]) && u(y, c) || (l = f ? b[c] : n[c], y[c] = d && "function" != typeof b[c] ? n[c] : m && f ? o(l, i) : g && b[c] == l ? function (t) {
    ...
    n(39), n(72), n(73), n(74), n(75), n(76), t.exports = n(79)
}, function (t, e, n) {
    "use strict";
    var i = n(1);
    i.define("brand", t.exports = function (t) {
        ...
        return n.ready = function () {
            ...
            /\.webflow\.io$/i.test(d) && s.hostname !== d && (u = !0), u && !c && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs"), i = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-icon.f67cd735e3.svg").css({
                marginRight: "8px",
                width: "16px"
    ...
    t.exports = function () {
        ...
        return t.template = function (e, n, i) {
            ...
            e.replace(r, function (t, n, i, r, u) {
                return a += e.slice(o, u).replace(y, w), o = u + t.length, n ? a += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : i ? a += "'+\n((__t=(" + i + "))==null?'':__t)+\n'" : r && (a += "';\n" + r + "\n__p+='"), t
    ...
    var i = n(0),
        ...
        V = function (t, e, n) {
            return t === $ && V(I, e, n), y(t), e = x(e, !0), y(n), r(q, e) ? (n.enumerable ? (r(t, F) && t[F][e] && (t[F][e] = !1), n = O(n, {
                enumerable: _(0, !1)
            })) : (r(t, F) || M(t, F, _(1, {})), t[F][e] = !0), G(t, e, n)) : M(t, e, n)
        },
        Y = function (t, e) {
            y(t);
        ...
        X = function (t) {
            ...
            return !(this === $ && r(q, t) && !r(I, t)) && (!(e || !r(this, t) || !r(q, t) || r(this, F) && this[F][t]) || e)
        },
        J = function (t, e) {
            if (t = b(t), e = x(e, !0), t !== $ || !r(q, e) || r(I, e)) {
                var n = T(t, e);
        ...
        Q = function (t) {
            for (var e, n = t === $, i = P(n ? I : b(t)), o = [], a = 0; i.length > a;) !r(q, e = i[a++]) || n && !r($, e) || o.push(q[e]);
            return o
        };
    R || (u((A = function () {
        ...
        var t = h(arguments.length > 0 ? arguments[0] : void 0),
            e = function (n) {
                this === $ && e.call(I, n), r(this, F) && r(this[F], t) && (this[F][t] = !1), G(this, t, _(1, n))
            };
        return o && H && G($, t, {
            configurable: !0,
            set: e
        ...
        return this._k
    }), S.f = J, E.f = V, n(37).f = k.f = Z, n(26).f = X, n(36).f = Q, o && !n(9) && u($, "propertyIsEnumerable", X, !0), p.f = function (t) {
        return B(d(t))
    }), a(a.G + a.W + a.F * !R, {
        Symbol: A
    });
    ...
    a(a.S + a.F * !R, "Symbol", {
        ...
        stringify: function (t) {
            ...
            if (n = e = i[1], (w(e) || void 0 !== t) && !W(t)) return g(e) || (e = function (t, e) {
        ...
        function v(e) {
            ...
            if (f.href = i, !(i.indexOf(":") >= 0)) {
                ...
                if (0 === i.indexOf("#") && h.test(i)) {
                    ...
                    var s = f.href === c.href || i === o || d.test(i) && p.test(o);
                    g(a, l, s)
                }
            }
        }
        ...
        function r(t) {
            ...
            function l(t) {
                if (a) {
                    ...
                    }), d()), (Math.abs(l - e) > 10 || Math.abs(h - n) > 10) && (u = !0)
                }
            }
    ...
    i.define("forms", t.exports = function (t, e) {
        ...
        function w(e, n) {
            ...
            o.handler = null, o.redirect = i.attr("data-redirect"), g.test(s) ? o.handler = k : s || (r ? o.handler = "function" == typeof hostedSubmitWebflow ? hostedSubmitWebflow : O : y())
        }
        ...
        return s.ready = s.design = s.preview = function () {
            ! function () {
                ...
                if (u = a + "/signFile", !(n = t(h + " form")).length) return;
                n.each(w)
    ...
    i.define("navbar", t.exports = function (t, e) {
        ...
        function P(t, e) {
            if (!t.open) {
                ...
                var r = A(t),
                    ...
                    s = t.el.height(),
                    f = t.el[0];
                if (T(0, f), y.intro(0, f), i.redraw.up(), a || l.on("tap" + p, t.outside), !e) {
                    var h = "transform " + n.duration + "ms " + n.easing;
                    if (t.overlay && (w = t.menu.prev(), t.overlay.show().append(t.menu)), n.animOver) return c(t.menu).add(h).set({
                        x: n.animDirect * u,
                        height: r
                    }).start({
                        x: 0
        ...
        function L(t, e) {
            if (t.open) {
                ...
                var n = t.config;
                if (("none" === n.animation || !c.support.transform || n.duration <= 0) && (e = !0), y.outro(0, t.el[0]), l.off("tap" + p, t.outside), e) return c(t.menu).stop(), void s();
            ...
            function s() {
                t.menu.height(""), c(t.menu).set({
                    x: 0,
                    y: 0
                }), t.menu.removeClass(m), t.links.removeClass(g), t.overlay && t.overlay.children().length && (w.length ? t.menu.insertAfter(w) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close")
            }
        }
        return s
    })
